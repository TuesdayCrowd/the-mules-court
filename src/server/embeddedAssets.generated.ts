...
import a7 from '../../dist/assets/index-B7URLw7n.css' with { type: 'file' };
import a8 from '../../dist/assets/index-DBnZIkxM.js' with { type: 'file' };
...
export const EMBEDDED: ReadonlyMap<string, string> = new Map([
    ...
    ['/assets/index-B7URLw7n.css', a7],
    ['/assets/index-DBnZIkxM.js', a8],
