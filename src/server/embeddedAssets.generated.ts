...
import a6 from '../../dist/assets/index-Blm8ACHJ.js' with { type: 'file' };
import a7 from '../../dist/assets/index-BxxXw_on.css' with { type: 'file' };
...
export const EMBEDDED: ReadonlyMap<string, string> = new Map([
    ...
    ['/assets/index-Blm8ACHJ.js', a6],
    ['/assets/index-BxxXw_on.css', a7],
