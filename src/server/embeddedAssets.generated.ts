...
import a7 from '../../dist/assets/index-BwhnjtUD.css' with { type: 'file' };
import a8 from '../../dist/assets/index-DW-uLm4r.js' with { type: 'file' };
...
export const EMBEDDED: ReadonlyMap<string, string> = new Map([
    ...
    ['/assets/index-BwhnjtUD.css', a7],
    ['/assets/index-DW-uLm4r.js', a8],
