...
import a8 from '../../dist/assets/index-B-Vj3MRs.js' with { type: 'file' };
import a9 from '../../dist/assets/index-DrIuumEe.css' with { type: 'file' };
...
export const EMBEDDED: ReadonlyMap<string, string> = new Map([
    ...
    ['/assets/index-B-Vj3MRs.js', a8],
    ['/assets/index-DrIuumEe.css', a9],
