...
import a6 from '../../dist/assets/index-C3cdMiRn.js' with { type: 'file' };
import a7 from '../../dist/assets/index-CTcUI5o6.css' with { type: 'file' };
...
export const EMBEDDED: ReadonlyMap<string, string> = new Map([
    ...
    ['/assets/index-C3cdMiRn.js', a6],
    ['/assets/index-CTcUI5o6.css', a7],
